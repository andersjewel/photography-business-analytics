...
A packaged Tableau workbook is included at `tableau/Wildlight_Analytics.twbx`. It embeds the synthetic booking-grain CSV, four worksheets, calculated fields, and an executive dashboard for immediate opening in Tableau Desktop or Tableau Public.
