...
An editable, schema-validated Power BI Project is included at `powerbi/WildlightAnalytics.pbip`. It imports the public synthetic analytics CSV from this repository and implements the five named report pages with data-bound visuals. Open it in Power BI Desktop to refresh, interact, restyle, or save a proprietary `.pbix` copy.
